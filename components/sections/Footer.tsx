...
const socialLinks = [
  ...
  { icon: Mail, href: "mailto:seydinat235@gmail.com", label: "Email" },
];
  ...
  return (
    ...
    >
      <span className="text-muted-foreground/40 text-xs select-none">
        ...
        <span className="text-red-400">♥</span> & trop de café
      </span>
      {/* Tooltip easter egg */}
      {revealed && (
        <span
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      slogan.innerHTML = original
        ...
        .map(
          (c) =>
            `<span class="slogan-char" style="display:inline-block">${c === " " ? "&nbsp;" : c}</span>`,
        )
        .join("");
    ...
    >
      ...
      <div className="container mx-auto px-4 py-12 md:py-16">
        <div className="flex flex-col items-center gap-8">
          ...
          <div
            className="footer-item w-full flex flex-col sm:flex-row items-center
